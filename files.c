/*
** files.c for my_ls in /home/gwitrand/Projects/Mini-project/PSU_2016_my_ls
**
** Made by Witrand Gaspard
** Login   <gwitrand@epitech.net>
**
** Started on  Sun Dec  4 22:41:07 2016 Witrand Gaspard
** Last update Sun Dec  4 22:41:07 2016 Witrand Gaspard
*/
				  ...
				  t_max_size *max)
{
  ...
  if ((tmp->infos = (t_file_info*)my_malloc(sizeof(t_file_info))) == NULL)
    return (-2);
  if ((lstat(tmp->name, &res_stat)) == -1)
  {
    error_output(tmp->name, 1);
    return (-1);
  }
